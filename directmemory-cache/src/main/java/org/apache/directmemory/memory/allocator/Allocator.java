...
public interface Allocator extends Closeable {
    ...
    /**
     * Returns the given {@link MemoryBuffer} making it available for a future usage. Returning twice
     * a {@link MemoryBuffer} won't throw an exception.
     *
     ...
     * @return a {@link MemoryBuffer} of the given size, or either return null or throw an
