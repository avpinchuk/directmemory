...
public class MemoryManagerServiceImplTest {
    ...
    @Test
    public void testFirstMatchBorderCase() throws IOException {
    ...
    @Test
    public void testAllocateMultipleBuffers() throws IOException {
    ...
    @Test
    public void testByteLeaking() throws IOException {
    ...
    @Test
    public void testReportCorrectUsedMemory() throws IOException {
    ...
    @Test
    public void testRandomPayload() throws IOException {
        final int NUMBER_OF_OBJECTS = 10;
        final int BUFFER_SIZE = NUMBER_OF_OBJECTS * SMALL_PAYLOAD.length;
