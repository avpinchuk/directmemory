...
public class DirectMemoryWriterTest {
    ...
    @Test
    public void writeRequestWithString() throws Exception {
    ...
    @Test
    public void writeRequestWithObject() throws Exception {
        Wine wine = new Wine();
    ...
    @Test
    public void writeResponseWithString() throws Exception {
